...
from docutranslate.exporter.lantern.tool.convert2png import convert_wmf_emf_to_png, convert_wmf_emf_to_png_async
...
class Lantern2HTMLExporter(LanternExporter):
    def __init__(self, config: Lantern2HTMLExporterConfig = None):
